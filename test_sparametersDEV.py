...
class SlabAu_model(meep_utils.AbstractMeepModel):
    def __init__(self, simtime=3.5e-13, resolution =5e-9,size_x =2.25e-6, size_y = 0.1e-6,
	...
	self.simulation_name = "SlabAuSubsCont3Drude"    
...
controlsample = 0
monitor_point = meep.vec(0, 0, model.monitor_z3)
x,y = [],[]
